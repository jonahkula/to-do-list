...
void prepend(List L, int data);      // insert new element into L. If L is non-empty, insertion takes place
                                     // before front element
void append(List L, int data);       // insert new element into L. If L is non-empty, insertion takes place
                                     // after back element
...
void set(List L, int x);             // overwrites the cursor element with x. Pre: length()>0, index()>=0
